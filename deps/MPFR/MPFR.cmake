...
if (MSVC)
    ...
    if(APPLE)
        set(_config_command_ "autoreconf -f -i && CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --prefix=${DESTDIR}/usr/local --enable-shared=no --enable-static=yes --with-gmp=${DESTDIR}/usr/local ${_gmp_build_tgt})
    else()
        set(_config_command_ "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --prefix=${DESTDIR}/usr/local --enable-shared=no --enable-static=yes --with-gmp=${DESTDIR}/usr/local ${_gmp_build_tgt})
    endif()
    ...
    ExternalProject_Add(dep_MPFR
        ...
        BUILD_IN_SOURCE ON
        CONFIGURE_COMMAND env ${_config_command_}
