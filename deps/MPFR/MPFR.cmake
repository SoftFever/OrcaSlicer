...
if (MSVC)
    ...
    ExternalProject_Add(dep_MPFR
        ...
        CONFIGURE_COMMAND autoreconf -f -i &&
                        env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --prefix=${DESTDIR} --enable-shared=no --enable-static=yes --enable-silent-rules --with-gmp=${DESTDIR} ${_gmp_build_tgt}
