...
if(DEFINED OPENSSL_ARCH)
    ...
    elseif(APPLE)
        set(_cross_arch "darwin64-${MACOS_ARCH}-cc")
	endif()
endif()
...
if(WIN32)
    ...
    set(_make_cmd nmake /S)
    set(_install_cmd nmake /S install_sw)
else()
    if(APPLE)
    ...
    set(_cross_comp_prefix_line "")
    set(_make_cmd make -j${NPROC} -s)
    set(_install_cmd make -j${NPROC} -s install_sw)
