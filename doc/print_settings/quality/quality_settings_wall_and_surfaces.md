...
Other flow ratios, such as ratios for outer and inner walls, overhang perimeters, sparse infill, internal solid infill, support, and support interfaces, can also be overridden after enabling the "Override other flow ratios" option.
