    ...
    const ConfigOptionResolver &old_config, const ConfigOptionResolver &new_config, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    for (const t_config_option_key &opt_key : opt_keys) {
        if (   opt_key == "brim_width"
            ...
            || opt_key == "precision_infill"
            || opt_key == "patchwork_surfaces"
            || opt_key == "patchwork_angle"
            || opt_key == "patchwork_tile_height"
            || opt_key == "patchwork_tile_width"
            || opt_key == "patchwork_tile_horizontal_joint"
            || opt_key == "patchwork_tile_vertical_joint"
            || opt_key == "patchwork_tiles_alternate_direction" 
            || opt_key == "patchwork_centering"
            || opt_key == "patchwork_subway_tiling"
            || opt_key == "patchwork_joints_flow_ratio"
            || opt_key == "initial_layer_line_width"
