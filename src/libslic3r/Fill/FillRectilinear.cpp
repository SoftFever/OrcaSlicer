...
// Orca: Introduced FillMonotonicLines from PrusaSlicer, inhereting from FillRectilinear
...
// Orca: Replaced with FillMonotonicLines from PrusaSlicer. Moved gap fill algorithm to
...
/*void FillMonotonicLineWGapFill::fill_surface_extrusion(const Surface* surface, const FillParams& params, ExtrusionEntitiesPtr& out)
{
    ...
    // Revert implementation to the PrusaSlicer approach that respects the infill/wall overlap setting
