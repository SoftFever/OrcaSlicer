...
//    const int                  infill_extruder      = region_config.infill_extruder.value;
    ...
    m_infill_extrusion_width = scaled<float>(region_config.sparse_infill_line_width.percent ? default_infill_extrusion_width * 0.01 * region_config.sparse_infill_line_width.value : region_config.sparse_infill_line_width.value);
