...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloatOrPercent,       infill_direction))
    ((ConfigOptionFloatOrPercent,       solid_infill_direction))
    ((ConfigOptionFloatOrPercent,       rotate_solid_infill_direction))
    ((ConfigOptionFloatOrPercent,       top_infill_direction))
    ((ConfigOptionFloatOrPercent,       bottom_infill_direction))
    ((ConfigOptionFloatOrPercent,       rotate_sparse_infill_direction))
    ((ConfigOptionFloatOrPercent,       rotate_sparse_infill_height))
    ((ConfigOptionFloatOrPercent,       sparse_infill_zigzag_angle))
    ((ConfigOptionFloatOrPercent,       sparse_infill_zigzag_height))
    ((ConfigOptionPercent,              sparse_infill_density))
    ((ConfigOptionEnum<InfillPattern>,  sparse_infill_pattern))
    ((ConfigOptionFloat,                lattice_angle_1))
    ((ConfigOptionFloat,                lattice_angle_2))
    ((ConfigOptionBool,                 apply_model_direction)) 
