...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionPercent, filament_ironing_flow))
    ((ConfigOptionFloat, filament_ironing_spacing))
    ((ConfigOptionFloat, filament_ironing_inset))
    ((ConfigOptionBool, enable_filament_ironing_flow))
    ((ConfigOptionBool, enable_filament_ironing_spacing))
    ((ConfigOptionBool, enable_filament_ironing_inset))
