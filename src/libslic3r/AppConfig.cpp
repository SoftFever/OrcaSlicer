...
static const std::string VERSION_CHECK_URL_STABLE = "https://api.github.com/repos/KrissMor/OrcaSlicerRED/releases/latest";
static const std::string VERSION_CHECK_URL = "https://api.github.com/repos/KrissMor/OrcaSlicerRED/releases";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/KrissMor/orcaslicerRED-profiles/releases/tags";
