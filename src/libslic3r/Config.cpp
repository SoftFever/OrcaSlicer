            ...
            if (boost::iequals(it.key(),BBL_JSON_KEY_VERSION)) {
                ...
                if (it.value().is_string()) {
                    ...
                    if (opt_key == "support_type") {
                        ...
                        if (it.value() == "outer wall/inner wall/infill" || it.value() == "infill/outer wall/inner wall" || it.value() == "inner-outer-inner wall/infill" || it.value() == "outer-odd-even wall/infill") {
