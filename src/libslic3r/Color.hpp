...
public:
    ...
    static const ColorRGB ORCA()		{ return {105.0f / 255.0f, 75.0f / 255.0f, 124.0f / 255.0f}; }
...
public:
    ...
    static const ColorRGBA ORCA()        { return {105.0f / 255.0f, 75.0f / 255.0f, 124.0f / 255.0f, 1.0f}; }
