...
class PrintRegion;
class PrintObject;
using SubSliceCollection = std::vector<std::pair<float, ExPolygons>>;
...
public:
    ...
    // slices generated between layers for smooth outer perimeter generation
    SubSliceCollection          sub_slices;
...
//    Polygons                    bridged;
    ...
    //BBS
    void    make_perimeters(const SurfaceCollection &slices, const SubSliceCollection& sub_slices, const LayerRegionPtrs &compatible_regions, SurfaceCollection* fill_surfaces, ExPolygons* fill_no_overlap);
