...
//            config.set_key_value("max_layer_z", new ConfigOptionFloat(m_max_layer_z));
            // BBS
            {
                ...
                //config.set_key_value("relative_e_axis", new ConfigOptionBool(m_config->use_relative_e_distances));
...
std::string GCode::set_extruder(unsigned int extruder_id, double print_z)
{
    ...
    //dyn_config.set_key_value("use_relative_e_distances", new ConfigOptionBool(use_relative_e_distances));
