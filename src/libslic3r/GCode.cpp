...
static double calculate_pressure_advance_for_nozzle(const std::string& pa_string, double nozzle_diameter) //TODO:CHECK
{
...
// Only add a newline in case the current G-code does not end with a newline.
    ...
    std::string WipeTowerIntegration::append_tcr(GCode& gcodegen, const WipeTower::ToolChangeResult& tcr, int new_filament_id, double z) const
    {
        ...
        //if (gcodegen.config().enable_pressure_advance.get_at(new_extruder_id)) { //TODO: CHECK
...
std::string GCode::set_extruder(unsigned int new_filament_id, double print_z, bool by_object)
{
    ...
    if (!m_writer.multiple_extruders) {
        ...
        //if (m_config.enable_pressure_advance.get_at(extruder_id)) {// TODO: CHECK
