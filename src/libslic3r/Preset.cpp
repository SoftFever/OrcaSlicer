...
static std::vector<std::string> s_Preset_print_options {
    ...
    "infill_direction",
    "minimum_sparse_infill_area", "reduce_infill_retraction","internal_solid_infill_pattern","enable_gap_fill_for_solid_infill","enable_gap_fill_for_top_bottom_surfaces",
