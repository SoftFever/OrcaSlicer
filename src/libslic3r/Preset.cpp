...
static std::vector<std::string> s_Preset_print_options {
    ...
    "infill_direction", "solid_infill_direction", "top_infill_direction", "bottom_infill_direction", "rotate_solid_infill_direction", "rotate_sparse_infill_direction", "rotate_sparse_infill_height", "sparse_infill_zigzag_angle", "sparse_infill_zigzag_height", "counterbore_hole_bridging",
