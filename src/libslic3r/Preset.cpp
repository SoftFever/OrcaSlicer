...
static std::vector<std::string> s_Preset_filament_options {
    ...
    // BBS
    "cool_plate_temp", "eng_plate_temp", "hot_plate_temp", "textured_plate_temp", "textured_plu_plate_temp", "cool_plate_temp_initial_layer", "eng_plate_temp_initial_layer", "hot_plate_temp_initial_layer","textured_plate_temp_initial_layer","textured_plu_plate_temp_initial_layer",
    // "bed_type",
