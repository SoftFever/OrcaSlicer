...
static std::vector<std::string> s_Preset_print_options {
    ...
    "align_infill_direction_to_model", "anisotropic_surfaces", "center_of_surface_pattern", "precision_surfaces",
    "patchwork_surfaces", "patchwork_angle", "patchwork_tile_height", "patchwork_tile_width", "patchwork_tile_horizontal_joint", "patchwork_tile_vertical_joint", "patchwork_tiles_alternate_angle", "patchwork_subway_tiling",
