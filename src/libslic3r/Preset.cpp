...
static std::vector<std::string> s_Preset_print_options {
    ...
    "infill_direction", "solid_infill_direction", "top_infill_direction", "bottom_infill_direction", "rotate_solid_infill_direction", "rotate_sparse_infill_direction", "rotate_sparse_infill_length", "sparse_infill_zigzag_angle", "sparse_infill_zigzag_length", "counterbore_hole_bridging",
