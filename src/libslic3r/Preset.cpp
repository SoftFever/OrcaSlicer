...
static std::vector<std::string> s_Preset_print_options {
    ...
    "wipe_tower_pulsatile_purge","wipe_tower_retraction_speed","wipe_tower_pulse_low_speed","wipe_tower_pulse_high_speed","wipe_tower_retraction_distance",
    "wipe_tower_extruder", "wiping_volumes_extruders","wipe_tower_bridging", "single_extruder_multi_material_priming",
