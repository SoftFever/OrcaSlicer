...
static std::vector<std::string> s_Preset_print_options {
    ...
    "top_shell_layers", "top_shell_thickness", "top_surface_multiline", "bottom_surface_multiline","top_surface_density", "bottom_surface_density", "bottom_shell_layers", "bottom_shell_thickness",
