...
bool Print::invalidate_state_by_config_options(const ConfigOptionResolver & /* new_config */, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    static std::unordered_set<std::string> steps_gcode = {
        ...
        "patchwork_surfaces", "patchwork_direction", "patchwork_tile_height",
        "patchwork_tile_width", "patchwork_tile_horizontal_joint", "patchwork_tile_vertical_joint",
        "patchwork_tiles_alternate_direction", "patchwork_subway_tiling", "patchwork_centering", "patchwork_joints_flow_ratio",
        "seam_gap",
