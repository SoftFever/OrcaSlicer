...
#define SETTING_PRINTER_SWITCH_BEHAVIOUR "project_switch_behaviour"
#define OPTION_PRINTER_SWITCH_BEHAVIOUR_ASK "always_ask"
#define OPTION_PRINTER_SWITCH_BEHAVIOUR_TRANSFER "transfer"
#define OPTION_PRINTER_SWITCH_BEHAVIOUR_DISCARD "discard"
