...
#define OPTION_PROJECT_LOAD_BEHAVIOUR_LOAD_ALL "0"
#define OPTION_PROJECT_LOAD_BEHAVIOUR_ASK_WHEN_RELEVANT "1"
#define OPTION_PROJECT_LOAD_BEHAVIOUR_ALWAYS_ASK "2"
#define OPTION_PROJECT_LOAD_BEHAVIOUR_LOAD_GEOMETRY "3"
