...
static t_config_enum_values s_keys_map_CenterOfSurfacePattern
{
    ...
    //{"printable_area", int(CenterOfSurfacePattern::Printable_Area)},
    //{"bed_center", int(CenterOfSurfacePattern::Bed_Center)},
    //{"bed_orign", int(CenterOfSurfacePattern::Bed_Orign)}
};
...
void PrintConfigDef::init_fff_params()
{
    ...
    def->sidetext = L("mm/s");	// unlike signs, units are translated into some languages
    def->min = 1;
    def->mode = comAdvanced;
    ...
    def->sidetext = L(u8"mm/s²");	// unlike signs, units are translated into some languages
    def->min = 0;
    def->mode = comAdvanced;
    ...
    def->sidetext = L("s");	// unlike signs, units are translated into some languages
    def->min = 0;
    def->max = 1000;
    def->mode = comSimple;
    ...
    */
    ...
    def->sidetext = L(u8"mm³");	// unlike signs, units are translated into some languages
    def->min = 0;
    def->mode = comAdvanced;
...
//    def->min = 0;
    ...
    def           = this->add("patchwork_surfaces", coBool);
    ...
    def           = this->add("patchwork_angle", coFloat);
    ...
    def->label    = L("Width of horizontal joint");
    def->category = L("Strength");
    ...
    def->label    = L("Width of vertical joint");
    def->category = L("Strength");
    def->tooltip  = L("(between tiles in lines) *** Need description ***\n"
                      "Negative value indicates an empty padding.");
    def->sidetext = L("lines");
    ...
    def->sidetext = L("mm");	// unlike signs, units are translated into some languages
    def->min = -10; // negative wipe make extra movement anong the path
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionFloats { 1. });
