...
struct FilamentType {
    ...
    double yiel_strength;
};

static std::vector<FilamentType> filament_types = {
        {"ABS",         190, 300, 50, 65,  1,   0.1},
        {"ABS-CF",      220, 300, 50, 65,  1,   0.1},
        {"ABS-GF",      240, 280, 50, 65,  1,   0.1},
        {"ASA",         220, 300, 50, 65,  1,   0.1},
        {"ASA-CF",      230, 300, 50, 65,  1,   0.1},
        {"ASA-GF",      240, 300, 50, 65,  1,   0.1},
        {"ASA-Aero",    240, 280, 50, 65,  1,   0.1},
        {"BVOH",        190, 240, 0,  70,  1,   0.02},
        {"EVA",         175, 220, 0,  50,  1,   0.02},
        {"FLEX",        210, 230, 0,  50,  0.5, 0.02},
        {"HIPS",        220, 270, 50, 60,  1,   0.02},
        {"PA",          235, 280, 50, 60,  1,   0.02},
        {"PA-CF",       240, 315, 50, 60,  1,   0.02},
        {"PA-GF",       240, 290, 50, 60,  1,   0.02},
        {"PA6",         260, 300, 50, 60,  1,   0.02},
        {"PA6-CF",      230, 300, 50, 60,  1,   0.02},
        {"PA6-GF",      260, 300, 50, 60,  1,   0.02},
        {"PA11",        275, 295, 50, 60,  1,   0.02},
        {"PA11-CF",     275, 295, 50, 60,  1,   0.02},
        {"PA11-GF",     275, 295, 50, 60,  1,   0.02},
        {"PA12",        250, 270, 50, 60,  1,   0.02},
        {"PA12-CF",     250, 300, 50, 60,  1,   0.02},
        {"PA12-GF",     255, 270, 50, 60,  1,   0.02},
        {"PAHT",        260, 310, 55, 65,  1,   0.02},
        {"PAHT-CF",     270, 310, 55, 65,  1,   0.02},
        {"PAHT-GF",     270, 310, 55, 65,  1,   0.02},
        {"PC",          240, 300, 60, 70,  1,   0.02},
        {"PC-ABS",      230, 270, 60, 70,  1,   0.02},
        {"PC-CF",       270, 295, 60, 70,  1,   0.02},
        {"PC-PBT",      260, 300, 60, 70,  1,   0.02},
        {"PCL",         130, 170, 0,  45,  1,   0.02},
        {"PCTG",        220, 300, 0,  55,  1,   0.02},
        {"PE",          175, 260, 45, 60,  1,   0.02},
        {"PE-CF",       175, 260, 45, 60,  1,   0.02},
        {"PE-GF",       230, 270, 45, 60,  1,   0.02},
        {"PEI-1010",    370, 430, 80, 100, 1,   0.02},
        {"PEI-1010-CF", 380, 430, 80, 100, 1,   0.02},
        {"PEI-1010-GF", 380, 430, 80, 100, 1,   0.02},
        {"PEI-9085",    350, 390, 80, 100, 1,   0.02},
        {"PEI-9085-CF", 365, 390, 80, 100, 1,   0.02},
        {"PEI-9085-GF", 370, 390, 80, 100, 1,   0.02},
        {"PEEK",        350, 460, 80, 100, 1,   0.02},
        {"PEEK-CF",     380, 410, 80, 100, 1,   0.02},
        {"PEEK-GF",     375, 410, 80, 100, 1,   0.02},
        {"PEKK",        325, 400, 80, 100, 1,   0.02},
        {"PEKK-CF",     360, 400, 80, 100, 1,   0.02},
        {"PES",         340, 390, 80, 100, 1,   0.02},
        {"PET",         200, 290, 0,  55,  2,   0.3},
        {"PET-CF",      240, 320, 0,  55,  2,   0.3},
        {"PET-GF",      280, 320, 0,  55,  2,   0.3},
        {"PETG",        190, 260, 0,  55,  1,   0.3},
        {"PETG-CF",     230, 290, 0,  55,  1,   0.3},
        {"PETG-GF",     210, 270, 0,  55,  1,   0.3},
        {"PHA",         190, 250, 0,  55,  1,   0.02},
        {"PI",          390, 410, 90, 100, 1,   0.02},
        {"PLA",         180, 240, 0,  45,  1,   0.02},
        {"PLA-AERO",    220, 270, 0,  55,  1,   0.02},
        {"PLA-CF",      190, 250, 0,  50,  1,   0.02},
        {"POM",         210, 250, 50, 65,  1,   0.02},
        {"PP",          200, 240, 45, 60,  1,   0.02},
        {"PP-CF",       210, 250, 45, 60,  1,   0.02},
        {"PP-GF",       220, 260, 45, 60,  1,   0.02},
        {"PPA-CF",      260, 300, 55, 70,  1,   0.02},
        {"PPA-GF",      260, 290, 55, 70,  1,   0.02},
        {"PPS",         300, 345, 90, 100, 1,   0.02},
        {"PPS-CF",      295, 350, 90, 100, 1,   0.02},
        {"PPSU",        360, 420, 90, 100, 1,   0.02},
        {"PSU",         350, 380, 90, 100, 1,   0.02},
        {"PVA",         185, 250, 0,  60,  1,   0.02},
        {"PVB",         190, 250, 0,  55,  1,   0.02},
        {"PVDF",        245, 265, 40, 60,  1,   0.02},
        {"SBS",         195, 250, 0,  55,  1,   0.02},
        {"TPI",         420, 445, 90, 100, 1,   0.02},
        {"TPU",         175, 260, 0,  50,  0.5, 0.02}
};
...
bool get_filament_yield_strength(const std::string& filament_type, double& yield_strength)
{
    ...
    for (const auto& filament : filament_types) {
        if (filament.name == filament_type) {
            yield_strength = filament.yiel_strength;
            return true;
        }
    }
    return false; // Filament type not found
