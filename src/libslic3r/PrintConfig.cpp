...
void PrintConfigDef::init_fff_params()
{
    ...
    def->sidetext = "mm/s";	// millimeters per second, don't need translation
    def->min = 1;
    def->mode = comAdvanced;
    ...
    def->tooltip = L("This setting stands for how much volume of filament can be melted and extruded per second. "
                     ...
                     "Can't be zero.");
    def->sidetext = u8"mm³/s";	// cubic millimeters per second, don't need translation
    def->min = 0;
    def->mode = comAdvanced;
    ...
    */
    ...
    def->sidetext = u8"mm³";	// cubic millimeters, don't need translation
    def->min = 0;
    def->mode = comAdvanced;
    ...
    def->sidetext = u8"g/cm³";	// grams per cubic millimeter, don't need translation
    def->min = 0;
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionFloats { 0. });
    ...
    def->sidetext = u8"mm³/s²";	// cubic millimeters per second squared, don't need translation
    def->min = 0;
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionFloat(0));
    ...
    def->sidetext = "mm²";	// square millimeters, don't need translation
    def->mode = comAdvanced;
    def->min = 0.;
    def->set_default_value(new ConfigOptionFloat(0.));
