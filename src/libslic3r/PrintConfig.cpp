...
//    def->min = 0;
    ...
    def->category = L("Quality");
    def->tooltip = L("The holes in objects will be grown or shrunk in the XY plane by the configured value. "
    ...
    def->category = L("Quality");
    def->tooltip = L("The contour of objects will be grown or shrunk in the XY plane by the configured value. "
    ...
    def->tooltip = L("Minimum thickness of thin features. Model features that are thinner than this value will not be printed, "
                     "while features thicker than the minimum feature size will be widened to the minimum wall width. "
                     "It's expressed as a percentage over nozzle diameter.");
    def->sidetext = "%";
    def->mode = comAdvanced;
    def->min = 0;
