...
void PrintConfigDef::init_fff_params()
{
    ...
    def->category = L("Quality");
    def->tooltip = L("Detours to avoid traveling across walls, which may cause blobs on the surface.");
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionBool(false));
    ...
    def->tooltip    = L("Bed temperature for layers except the initial one. "
                     "Value 0 means the filament does not support printing on the Cool Plate.");
    def->sidetext   = "°C";
    ...
    def->label = L("Other layers");
    def->tooltip = L("Bed temperature for layers except the initial one. "
        "Value 0 means the filament does not support printing on the Textured Cool Plate.");
    def->sidetext = L("°C");
    def->full_label = L("Bed temperature");
    def->min = 0;
    def->max = 300;
    ...
    def->label = L("Other layers");
    def->tooltip = L("Bed temperature for layers except the initial one. "
        "Value 0 means the filament does not support printing on the Engineering Plate.");
    def->sidetext = L("°C");
    def->full_label = L("Bed temperature");
    def->min = 0;
    def->max = 300;
    ...
    def->label = L("Other layers");
    def->tooltip = L("Bed temperature for layers except the initial one. "
        "Value 0 means the filament does not support printing on the High Temp Plate.");
    def->sidetext = L("°C");
    def->full_label = L("Bed temperature");
    def->min = 0;
    def->max = 300;
    ...
    def->label      = L("Other layers");
    def->tooltip    = L("Bed temperature for layers except the initial one. "
                     "Value 0 means the filament does not support printing on the Textured PEI Plate.");
    def->sidetext   = L("°C");
    def->full_label = L("Bed temperature");
    def->min        = 0;
    def->max        = 300;
    ...
    def->tooltip = L("Bed temperature of the initial layer. "
        "Value 0 means the filament does not support printing on the Cool Plate SuperTack.");
    def->sidetext = "°C";
    def->min = 0;
    def->max = 120;
    def->set_default_value(new ConfigOptionInts{ 35 });
    ...
    def->tooltip = L("This option enables the generation of an extra bridge layer over internal and/or external bridges.\n\n"
                     ...
                     "bridges count towards the top shell layer count of your model. The second internal bridge layer will be extruded as close to perpendicular to the first as possible. "
    ...
    def->tooltip = L("Print sequence of the internal (inner) and external (outer) walls.\n\n"
                     ...
                     "neighbouring perimeter while printing. However, this option results in slightly reduced "
                     "surface quality as the external perimeter is deformed by being squashed to the internal "
                     "perimeter.\n\n"
                     ...
                     "perimeter onwards first, then the external perimeter and, finally, the first internal "
                     "perimeter. This option is recommended against the Outer/Inner option in most cases.\n\n"
                     "Use Outer/Inner for the same external wall quality and dimensional accuracy benefits of "
                     "Inner/Outer/Inner option. However, the z seams will appear less consistent as the first "
                     "extrusion of a new layer starts on a visible surface.");
    ...
    */
    ...
    def->tooltip = L("Infill area is enlarged slightly to overlap with wall for better bonding. "
                     ...
                     "Set this value to ~10-15% to minimize potential over extrusion and accumulation of material resulting in rough top surfaces.");
    def->sidetext = L("%");
    def->ratio_over = "inner_wall_line_width";
    def->mode = comAdvanced;
    ...
    def->tooltip = L("Object will be raised by this number of support layers. "
                     "Use this function to avoid wrapping when printing ABS.");
    def->sidetext = L("layers");
    def->min = 0;
    def->max = 100;
    def->mode = comAdvanced;
...
//    def->min = 0;
    ...
    def->tooltip = L("This G-code is inserted when change filament, including T command to trigger tool change.");
    def->multiline = true;
    def->full_width = true;
    def->height = 5;
    def->mode = comAdvanced;
    ...
    //                 "Zero means using travel speed directly in gcode, but will be limited by printer's ability when run G-code.");
    def->sidetext = L("mm/s");
    def->min = 0;
    def->mode = comDevelop;
    def->set_default_value(new ConfigOptionFloat(0.));
