...
void adjust_settings_for_flowrate_calib(ModelObjectPtrs& objects, bool linear, int pass)
{
    ...
    for (auto _obj : objects) {
        ...
        _obj->config.set_key_value("infill_direction", new ConfigOptionFloatOrPercent(45.0f, false));
        _obj->config.set_key_value("solid_infill_direction", new ConfigOptionFloatOrPercent(135.0f, false));
        _obj->config.set_key_value("rotate_solid_infill_direction", new ConfigOptionFloatOrPercent(90.0f, false));
        _obj->config.set_key_value("top_infill_direction", new ConfigOptionFloatOrPercent(45.0f, false));
        _obj->config.set_key_value("bottom_infill_direction", new ConfigOptionFloatOrPercent(45.0f, false));
        _obj->config.set_key_value("apply_model_direction", new ConfigOptionBool(true));
        _obj->config.set_key_value("rotate_sparse_infill_direction", new ConfigOptionFloatOrPercent(0.0f, false));
        _obj->config.set_key_value("rotate_sparse_infill_height", new ConfigOptionFloatOrPercent(0, false));
        _obj->config.set_key_value("sparse_infill_zigzag_angle", new ConfigOptionFloatOrPercent(0.0f, false));
        _obj->config.set_key_value("sparse_infill_zigzag_height", new ConfigOptionFloatOrPercent(0, false));      
