...
void adjust_settings_for_flowrate_calib(ModelObjectPtrs& objects, bool linear, int pass)
{
    ...
    for (auto _obj : objects) {
        ...
        _obj->config.set_key_value("precision_surfaces", new ConfigOptionBool(false));
        _obj->config.set_key_value("patchwork_surfaces", new ConfigOptionBool(false));
        _obj->config.set_key_value("patchwork_angle", new ConfigOptionFloat(0.f));
        ...
        _obj->config.set_key_value("patchwork_tiles_alternate_angle", new ConfigOptionString("+90"));
