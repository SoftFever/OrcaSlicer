...
>>>>>>> 2f17ff28d (About Dialog switched to JusPrin)
...
// #endif
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2022-2024 Obico All Rights Reserved", wxDefaultPosition, wxDefaultSize);
