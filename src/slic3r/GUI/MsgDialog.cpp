...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        ...
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try OrcaSlicer Beta, you may click to"));
        ...
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your OrcaSlicer could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
