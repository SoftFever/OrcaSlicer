...
wxString PresetComboBox::get_tooltip(const Preset &preset)
{
    ...
    if (m_type == Preset::TYPE_FILAMENT && preset.config.has("filament_notes")) {
        const ConfigOptionStrings* notes_opt = preset.config.option<ConfigOptionStrings>("filament_notes");
