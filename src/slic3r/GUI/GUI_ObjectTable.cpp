...
void ObjectTablePanel::load_data()
{
    ...
    m_object_grid->SetColLabelValue(ObjectGridTable::col_plate_index, wxString::Format("%S%S", _L("Plate"), wxString::FromUTF8(u8"\u2191\u2193" /* ↑↓ */)));
    /*m_object_grid->SetColLabelValue(ObjectGridTable::col_assemble_name, L("Module"));*/
    m_object_grid->SetColLabelValue(ObjectGridTable::col_name, wxString::Format("%S%S", _L("Name"), wxString::FromUTF8(u8"\u2191\u2193" /* ↑↓ */)));
    m_object_grid->SetColLabelValue(ObjectGridTable::col_filaments, wxString::Format("%S%S", _L("Filament"), wxString::FromUTF8(u8"\u2191\u2193"  /* ↑↓ */)));
