...
void ExtrusionCalibration::create()
{
    ...
    m_nozzle_temp = new TextInput(m_step_1_panel, wxEmptyString, wxString::FromUTF8(u8"\u2103") /* °C */, "", wxDefaultPosition, { max_input_width, EXTRUSION_CALIBRATION_INPUT_SIZE.y }, wxTE_READONLY);
    ...
    m_bed_temp = new TextInput(m_step_1_panel, wxEmptyString, wxString::FromUTF8(u8"\u2103") /* °C */, "", wxDefaultPosition, { max_input_width, EXTRUSION_CALIBRATION_INPUT_SIZE.y }, wxTE_READONLY);
    ...
    m_max_flow_ratio = new TextInput(m_step_1_panel, wxEmptyString, wxString::FromUTF8(u8"mm\u00b3" /* mm³ */), "", wxDefaultPosition, { max_input_width, EXTRUSION_CALIBRATION_INPUT_SIZE.y }, wxTE_READONLY);
