...
static const std::string ctrl_t = "\u2318"; // "⌘" (Mac Command)
#else
...
void MainFrame::init_menubar_as_editor()
{
    ...
    wxMenu* fileMenu = new wxMenu;
    {
        ...
        append_menu_item(import_menu, wxID_ANY, _L("Import Configs") + dots /*+ "\t" + _L("Ctrl+") + "I"*/, _L("Load configs"),
        ...
        append_menu_item(export_menu, wxID_ANY, _L("Export all objects as STLs") + dots, _L("Export all objects as STLs"),
            ...
            [this](){return can_export_model(); }, this);
        append_menu_item(export_menu, wxID_ANY, _L("Export Generic 3MF") + dots/* + "\t" + _L("Ctrl+") + "G"*/, _L("Export 3mf file without using some 3mf-extensions"),
        ...
        append_menu_item(export_menu, wxID_ANY, _L("Export all plate sliced file") + dots/* + "\t" + _L("Ctrl+") + "G"*/, _L("Export all plate sliced file"),
        ...
        append_menu_item(export_menu, wxID_ANY, _L("Export G-code") + dots/* + "\t" + _L("Ctrl+") + "G"*/, _L("Export current plate as G-code"),
            [this](wxCommandEvent&) { if (m_plater) m_plater->export_gcode(false); }, "menu_export_gcode", nullptr,
            [this]() {return can_export_gcode(); }, this);
        append_menu_item(
            export_menu, wxID_ANY, _L("Export Preset Bundle") + dots /* + "\t" + _L("Ctrl+") + "E"*/, _L("Export current configuration to files"),
    ...
    auto handle_key_event = [](wxKeyEvent& evt) {
        ...
        editMenu->AppendSeparator();
        // BBS Clone Selected
        append_menu_item(editMenu, wxID_ANY, _L("Clone selected") /*+ "\t" + _L("Ctrl+") + "M"*/,
    ...
    if (m_plater) {
        ...
        /*viewMenu->AppendSeparator();
        append_menu_check_item(viewMenu, wxID_ANY, _L("Show &Wireframe") + "\t" + _L("Ctrl+") + _L("Shift+") + _L("Enter"), _L("Show wireframes in 3D scene."),
    ...
    //auto preference_item = new wxMenuItem(parent_menu, OrcaSlicerMenuPreferences + bambu_studio_id_base, _L("Preferences") + "\t" + _L("Ctrl+") + ",", "");
#else
...
void MainFrame::init_menubar_as_gcodeviewer()
{
    ...
    wxMenu* fileMenu = new wxMenu;
    {
        append_menu_item(fileMenu, wxID_ANY, _L("&Open G-code") + dots + "\t" + _L("Ctrl+") + "O", _L("Open a G-code file"),
            [this](wxCommandEvent&) { if (m_plater != nullptr) m_plater->load_gcode(); }, "open", nullptr,
            [this]() {return m_plater != nullptr; }, this);
#ifdef __APPLE__
        append_menu_item(fileMenu, wxID_ANY, _L("Re&load from Disk") + dots + "\t" + _L("Ctrl+") + _L("Shift+") + "R",
