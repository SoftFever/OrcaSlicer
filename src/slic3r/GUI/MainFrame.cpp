...
void MainFrame::init_menubar_as_editor()
{
    ...
    if (m_plater) {
        ...
        /*viewMenu->AppendSeparator();
        append_menu_check_item(viewMenu, wxID_ANY, _L("Show &Wireframe") + "\t" + ctrl + _L("Shift+") + _L("Enter"), _L("Show wireframes in 3D scene."),
...
#ifdef __APPLE__
        // FIXME: maybe should be using GUI::shortkey_ctrl_prefix() or equivalent?
        append_menu_item(fileMenu, wxID_ANY, _L("Re&load from Disk") + dots + "\t" + ctrl + _L("Shift+") + "R",
