    ...
    : DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("Bind with Pin Code"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    m_status_text->SetForegroundColour(wxColour(48, 38, 38));
...
PingCodeBindDialog::~PingCodeBindDialog() {
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
     ...
     m_st_privacy_title->SetForegroundColour(wxColour(48, 38, 38));
     ...
     m_link_Terms_title->SetForegroundColour(wxColour(0xd72828));
     ...
     m_st_and_title->SetForegroundColour(wxColour(48, 38, 38));
     ...
     m_link_privacy_title->SetForegroundColour(wxColour(0xd72828));
     ...
     m_st_notice_title->SetForegroundColour(wxColour(48, 38, 38));
     ...
     m_link_notice_title->SetForegroundColour(wxColour(0xd72828));
...
UnBindMachineDialog::UnBindMachineDialog(Plater *plater /*= nullptr*/)
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log out printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
    m_tocken.reset(new int(0));
     ...
     StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(253, 47, 47), StateColor::Hovered),
                             std::pair<wxColour, int>(wxColour(215, 40, 40), StateColor::Normal));
     m_button_unbind->SetBackgroundColor(btn_bg_green);
     m_button_unbind->SetBorderColor(wxColour(215, 40, 40));
