...
void CaliPresetCustomRangePanel::create_panel(wxWindow* parent)
{
    ...
    for (size_t i = 0; i < m_input_value_nums; ++i) {
        ...
        m_value_inputs[i] = new TextInput(parent, wxEmptyString, wxString::FromUTF8(u8"\u2103" /* °C */), "", wxDefaultPosition, CALIBRATION_FROM_TO_INPUT_SIZE, 0);
...
void CaliPresetTipsPanel::create_panel(wxWindow* parent)
{
    ...
    m_nozzle_temp = new TextInput(parent, wxEmptyString, wxString::FromUTF8(u8"\u2103" /* °C */), "", wxDefaultPosition, CALIBRATION_FROM_TO_INPUT_SIZE, wxTE_READONLY);
    ...
    m_bed_temp = new Label(parent, wxString::FromUTF8(u8"- \u2103" /* °C */));
    ...
    m_max_volumetric_speed = new TextInput(parent, wxEmptyString, wxString::FromUTF8(u8"mm\u00b3" /* mm³ */), "", wxDefaultPosition, CALIBRATION_FROM_TO_INPUT_SIZE, wxTE_READONLY);
...
void CaliPresetTipsPanel::set_params(int nozzle_temp, int bed_temp, float max_volumetric)
{
    ...
    m_bed_temp->SetLabel(wxString::FromUTF8(bed_temp_text + u8"\u2103" /* °C */));
    ...
    : CalibrationPresetPage(parent, cali_mode, custom_range, id, pos, size, style)
{
    if (custom_range && m_custom_range_panel) {
        ...
        m_custom_range_panel->set_unit(wxString::FromUTF8(u8"mm\u00b3/s" /* mm³/s */));
    }
}
}}
