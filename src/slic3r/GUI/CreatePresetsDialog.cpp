...
#define SELECT_ALL_OPTION_COLOUR wxColour("#eb4949")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(235, 73, 73), StateColor::Pressed), std::pair<wxColour, int>(wxColour(235, 73, 73), StateColor::Hovered),
