...
/*#ifdef __WXOSX__
    ...
    if (m_presets_choice) {
        ...
        m_top_sizer->Add(m_presets_choice, 1, wxLEFT | wxRIGHT | wxALIGN_CENTER_VERTICAL, FromDIP(5)); // Element Spacing for both side
    } else {
    ...
    m_top_sizer->AddSpacer(10); // Icon spacing
#endif
    m_top_sizer->Add(m_btn_save_preset, 0, wxALIGN_CENTER_VERTICAL, 0); // Element Spacing added con combo box
