...
/*#ifdef __WXOSX__
    ...
    m_top_sizer->Add(m_undo_btn, 0, wxLEFT | wxALIGN_CENTER_VERTICAL, FromDIP(12)); // Content_Margin
    // BBS: model config
    if (m_presets_choice) {
        m_presets_choice->Reparent(m_top_panel);
        m_top_sizer->Add(m_presets_choice, 1, wxLEFT | wxRIGHT | wxALIGN_CENTER_VERTICAL, FromDIP(5)); // Element_Spacing for both side
    } else {
    ...
    m_top_sizer->AddSpacer(10); // Icon_Spacing
#endif
    m_top_sizer->Add(m_btn_save_preset, 0, wxALIGN_CENTER_VERTICAL, 0); // Element_Spacing added from combo box
    m_top_sizer->Add(m_btn_delete_preset, 0, wxALIGN_CENTER_VERTICAL | wxLEFT, FromDIP(10)); // Icon_Spacing
    m_top_sizer->Add(m_btn_search, 0, wxALIGN_CENTER_VERTICAL | wxLEFT, FromDIP(10)); // Icon_Spacing
    m_top_sizer->Add(m_search_item, 1, wxALIGN_CENTER_VERTICAL | wxLEFT, FromDIP(12)); // Content_Margin
    ...
    if (dynamic_cast<TabPrint*>(this) == nullptr) {
        ...
        m_top_sizer->Add(m_static_title, 0, wxALIGN_CENTER_VERTICAL | wxLEFT, FromDIP(10)); // Icon_Spacing
        m_mode_view = new SwitchButton(m_top_panel, wxID_ABOUT);
        m_top_sizer->AddSpacer(FromDIP(5)); // Element_Spacing
        m_top_sizer->Add( m_mode_view, 0, wxALIGN_CENTER_VERTICAL);
    }

    m_top_sizer->AddSpacer(FromDIP(12)); // Content_Margin
