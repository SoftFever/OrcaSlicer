    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(199, 24, 24), StateColor::Pressed);
    border_color.append(wxColour(245, 100, 100), StateColor::Hovered);
    border_color.append(0xeb4949, StateColor::Normal);
    ...
    background_color.append(wxColour(199, 24, 24), StateColor::Pressed);
    background_color.append(wxColour(245, 100, 100), StateColor::Hovered);
    background_color.append(0xeb4949, StateColor::Normal);
