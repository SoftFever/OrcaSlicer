    ...
    , state_handler(this)
{
    ...
    border_color.append(0x5a416b, StateColor::Pressed);
    border_color.append(0x7d5c93, StateColor::Hovered);
    border_color.append(0x694b7c, StateColor::Normal);
    ...
    background_color.append(0x5a416b, StateColor::Pressed);
    background_color.append(0x7d5c93, StateColor::Hovered);
    background_color.append(0x694b7c, StateColor::Normal);
