...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(199, 24, 24), StateColor::Pressed),
        ...
        edit_button->SetBorderColor(wxColour(235, 73, 73));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(235, 73, 73));
