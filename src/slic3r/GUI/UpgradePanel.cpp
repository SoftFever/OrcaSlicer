...
static const wxColour TEXT_NORMAL_CLR = wxColour(235, 73, 73);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(199, 24, 24), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(245, 100, 100), StateColor::Hovered), std::pair<wxColour, int>(wxColour(235, 73, 73), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(235, 73, 73), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(235, 73, 73), StateColor::Enabled));
