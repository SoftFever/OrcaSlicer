    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0xeb4949));
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(199, 24, 24), StateColor::Pressed), std::pair<wxColour, int>(wxColour(245, 100, 100), StateColor::Hovered),
    ...
    m_statictext_finish->SetForegroundColour(wxColour(235, 73, 73));
