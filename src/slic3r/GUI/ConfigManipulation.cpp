...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig *config, const bool is_global_config)
{
    ...
    for (auto el : { "infill_direction", "sparse_infill_line_width",
        ...
        "solid_infill_direction", "rotate_solid_infill_direction", "rotate_sparse_infill_direction", "rotate_sparse_infill_length", "sparse_infill_zigzag_angle", "sparse_infill_zigzag_length", "internal_solid_infill_pattern", "solid_infill_filament",
        })
