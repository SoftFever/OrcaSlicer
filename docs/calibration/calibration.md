...
!!!WARNING
    For Bambulab `X1/X1C` or `A1/A1 mini` users, make sure you do not select the 'Flow calibration' option.

    ![uncheck](https://user-images.githubusercontent.com/103989404/221345187-3c317a46-4d85-4221-99b9-adb5c7f48026.jpeg)  

![flowrate](../assets/images/flow-calibration.gif)
...
5. Update the flow ratio in the filament settings using the following equation: `< FlowRatio_old > * (100 + < modifier >) / 100`. If your previous flow ratio was `0.98` and you selected the block with a flow rate modifier of `+5`, the new value should be calculated as follows: `0.98 x (100 + 5) / 100 = 1.029`. **Remember** to save the filament profile.
6. Perform the `Pass 2` calibration. This process is similar to `Pass 1`, but a new project with ten blocks will be generated. The flow rate modifiers for this project will range from `-9 to 0`.
7. Repeat steps 4 and 5. In this case, if your previous flow ratio was 1.029 and you selected the block with a flow rate modifier of -6, the new value should be calculated as follows: `1.029 x (100 - 6) / 100 = 0.96726`. **Remember** to save the filament profile.  
...
![flow-calibration-update-flowrate](../assets/images/flow-calibration-update-flowrate.png)
...
!!!WARNING
    For Bambulab `X1/X1C` or `A1/A1 mini` users, make sure you do not select the 'Flow calibration' option when printings.
...
![pressure-advance-calibration](../assets/images/pressure-advance-calibration.png)
...
## Temp tower 
![image](../assets/images/temp_tower_test.gif)  
...
## Retraction test
![image](../assets/images/retraction_test.gif)  
...
![image](../assets/images/retraction_test_dlg.png)  
...
![image](../assets/images/retraction_test_print.jpg)  
...
![image](../assets/images/tolerance_hole.jpg) 

You can assess the tolerance using either an M6 Allen key or the printed hexagon tester.  
![image](../assets/images/OrcaToleranceTes_m6.jpg)  
![image](../assets/images/OrcaToleranceTest_print.jpg)  
...
![image](../assets/images/vmf_measurement_point.jpg)
...
![image](../assets/images/caliper_sample_mvf.jpg)
...
![image](../assets/images/max_volumetric_flow.jpg)
...
The `VFA` test is design to optimized printing speed to reduce vfa. The belt tension also difference in motor driver or motor may lead to different results on vfa test. This test will able find the optimized printing speed for the printer. 

You will be promted to enter the settings for the test: `Start speed`, `End speed`, and `step`. It is recommended to use the default values (40mm/s start, 200mm/s end, with a step of 10), unless you already have an idea of the lower or upper limit for your printer. Select "OK", slice the plate, and send it to the printer. 

![vfa-setting](../assets/images/vfa-setting.png)

Once printed, take note of which part has the least vfa.

![vfa-view](../assets/images/vfa-view.png)
